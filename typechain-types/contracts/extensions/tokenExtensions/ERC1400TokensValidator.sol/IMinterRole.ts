...
export interface IMinterRoleInterface extends Interface {
  getFunction(nameOrSignature: "isMinter"): FunctionFragment;
...
export interface IMinterRole extends BaseContract {
  connect(runner?: ContractRunner | null): IMinterRole;
