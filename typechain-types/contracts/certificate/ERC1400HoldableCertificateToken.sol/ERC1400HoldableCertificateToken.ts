...
export interface ERC1400HoldableCertificateTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addMinter"
      | "allowance"
...
export interface ERC1400HoldableCertificateToken extends BaseContract {
  connect(runner?: ContractRunner | null): ERC1400HoldableCertificateToken;
  ...
  canOperatorTransferByPartition: TypedContractMethod<
    [
      partition: BytesLike,
      from: AddressLike,
      to: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "canOperatorTransferByPartition"
  ): TypedContractMethod<
    [
      partition: BytesLike,
      from: AddressLike,
